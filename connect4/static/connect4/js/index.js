...
function drawAllLines(whiteArr,blackArr){
...
const finsihGame = (obj={})=>{
    ...
    .then(data=>{
        ...
        let poslednjiObojeniDiv=document.getElementsByClassName('poslednji-potez')[0];
        if(poslednjiObojeniDiv!=undefined)
        poslednjiObojeniDiv.classList.remove('poslednji-potez')
        ...
        drawAllLines(whiteArr,blackArr);
    })
    .catch(error=>{});
}
...
function createCircle(currentField,i,j,whiteOnMove){
    let zadnjiObojeniDiv = document.getElementsByClassName('poslednji-potez')[0];
    console.log(zadnjiObojeniDiv);
    // zadnjiObojeniDiv.className="boardField"; //[el1]
    if(zadnjiObojeniDiv!=undefined){
        zadnjiObojeniDiv.classList.remove('poslednji-potez');
    }
    currentField.classList.add('poslednji-potez');
...
function movePlayed(e){
    ...
    .then(data=>{
        ...
        //nacrtaj sve linije posle svakog poteza
